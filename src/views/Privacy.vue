...
Stelle" oder dem "Impressum" in dieser Datenschutzerklärung entnehmen.
    </p>
    ...
    <p>
      ...
      und Zweck Ihrer gespeicherten personenbezogenen Daten zu erhalten.
      Sie haben außerdem ein Recht, die Berichtigung oder Löschung dieser Daten zu verlangen.<br />
      Wenn Sie eine Einwilligung zur Datenverarbeitung erteilt haben, können Sie diese
      Einwilligung jederzeit für die Zukunft widerrufen.<br />
    ...
    <h2>2. Hosting & Daten zur Analyse</h2>
    <h3>Externes Hosting</h3>
    <p>
      Diese Website wird extern gehostet.<br /> 
      Die personenbezogenen Daten, die auf dieser Website erfasst werden, werden auf den Servern des Hosters / der Hoster gespeichert.<br /> 
      Hierbei kann es sich v. a. um IP-Adressen, Kontaktanfragen, Meta- und Kommunikationsdaten, Vertragsdaten, Kontaktdaten, Namen, Websitezugriffe und
      sonstige Daten, die über eine Website generiert werden, handeln.<br /> 
      Das externe Hosting erfolgt zum Zwecke der Vertragserfüllung gegenüber unseren potenziellen und bestehenden Kunden (Art. 6 Abs. 1 lit. b DSGVO) und im Interesse einer
      sicheren, schnellen und effizienten Bereitstellung unseres Online-Angebots durch
      einen professionellen Anbieter (Art. 6 Abs. 1 lit. f DSGVO).<br />
    ...
    <h3>^3. Allgemeine Hinweise zu den Rechtsgrundlagen der Datenverarbeitung auf dieser Website</h3>
    <p>
...
Widerruf unberührt.
    ...
    <h3>Widerspruchsrecht gegen die Datenerhebung in besonderen Fällen gegenm Direktwerbung (Art. 21 DSGVO)</h3>
    <p>
Wenn die Datenverarbeitung auf Art. 6 Abs. 1 lit. e oder f DSGVO beruht, haben sie das Recht, jederzeit aus Gründen, die sich aus ihrer besonderen Situation ergeben,
gegen die Verarbeitung ihrer personenbezogenen Daten, auch gegen ein auf diese Bestimmungen gestütztes Profiling, Widerspruch einzulegen.
Die jeweilige Rechtsgrundlage, auf die sich eine Verarbeitung stützt, entnehmen Sie bitte dieser Datenschutzerklärung.
Im Falle eines Widerspruchs werden wir die betreffenden personenbezogenen Daten nicht mehr verarbeiten, es sei denn,
wir können zwingende schutzwürdige Gründen für die Verarbeitung nachweisen, die ihre Interessen, Rechte und Freiheiten überwiegen,
oder die Verarbeitung dient der Geltendmachung, Ausübung oder Verteidigung von Rechten (Widerspruch gem. Art. 21 Abs. 1 DSGVO. 21 Abs. 1 DSGVO).
Werden Ihre personenbezogenen Daten verarbeitet, um Direktwerbung zu betreiben, haben Sie das Recht, jederzeit gegen die Verarbeitung Ihrer personenbezogenen
Daten zum Zwecke der Direktwerbung Widerspruch einzulegen; dies gilt auch für das Profiling, soweit es mit solcher Direktwerbung in Verbindung steht.
Wenn Sie widersprechen, werden Ihre personenbezogenen Daten anschließend nicht mehr für Zwecke der Direktwerbung verwendet (Widerspruch nach Art. 21 Abs. 2 DSGVO).
    </p>
    ...
    <p>
      Diese Seite nutzt aus Sicherheitsgründen und zum Schutz der Übertragung vertraulicher Inhalte, wie zum Beispiel Bestellungen oder Anfragen, die Sie an uns als Seitenbetreiber senden, eine SSL- bzw. TLS-Verschlüsselung. Eine verschlüsselte Verbindung erkennen Sie daran, dass die Adresszeile des Browsers von „http://“ auf „https://“ wechselt und an dem Schloss-Symbol in Ihrer Browserzeile. Sollte dies nicht automatisch der Fall sein, wird darum gebeten, dass sie das Protokoll selber von "http" auf "https" ändern.
      <br />
...
müssen die Server-Log-Files erfasst werden.
    ...
    <h3>Anfragen per E-Mail oder Telefon</h3>
    <p>
